				...
				<input
					...
					className={
						inputType === 'amount'
							...
							: 'placeholder:text-bcpayment-gray-2 px-4 font-medium text-[15px] py-[30px] shadow-xl'
					}
					{...field}
					{...(props as any)}
				/>
				<p className='absolute -translate-y-1/2 right-5 top-1/2 text-bcpayment-green-3'>BNB</p>
			</div>
